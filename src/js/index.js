...
function scrollUp() {
  ...
  if (this.scrollY >= 230) scrollUp.classList.add("showscroll");
  else scrollUp.classList.remove("showscroll");
}
window.addEventListener("scroll", scrollUp);

function showwapp() {
  const showwapp = document.getElementById("wapp");
  if (this.scrollY >= 150) showwapp.classList.add("showWapp");
  else showwapp.classList.remove("showWapp");
}
window.addEventListener("scroll", showwapp);

function showphone() {
  const showphone = document.getElementById("phone");
  if (this.scrollY >= 190) showphone.classList.add("showphone");
  else showphone.classList.remove("showphone");
}
